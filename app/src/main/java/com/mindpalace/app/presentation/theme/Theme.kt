...
private val LightColors = lightColorScheme(
    ...
    onPrimary = Color(0xFFFCF7FF),      // TextPrimary - Dark Gray
    onSecondary = Color(0xFFF2EFF2),    // TextSecondary - Muted Gray
...
private val DarkColors = darkColorScheme(
    ...
    onSecondary = Color(0xFF3A3A3A),    // Dark text on lighter secondary buttons
